...
public class TestEtiquetaDAO {
	...
	public static void main(String[] args){
		...
		try {
			...
			System.out.println(dao.findById(conexion, 1l).toString());
			System.out.println();
			System.out.println();
			...
			uno = dao.create(conexion, uno);
			System.out.println(uno.toString());

			dos = dao.create(conexion, dos);
			System.out.println(dos.toString());

			tres = dao.create(conexion, tres);
			System.out.println(tres.toString());

			System.out.println("FIND BY ID");

			System.out.println(dao.findById(conexion, uno.getIdEtiqueta()).toString());
			System.out.println(dao.findById(conexion, dos.getIdEtiqueta()).toString());
			System.out.println(dao.findById(conexion, tres.getIdEtiqueta()).toString());
